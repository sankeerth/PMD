...
void POD::write_pod_rms_error_binary_1D_procs_along_col_data_transposed() {
    LOGR("=========== write_pod_rms_error_binary_1D_procs_along_col_data_transposed ===========", pod_context.my_rank, pod_context.master);
